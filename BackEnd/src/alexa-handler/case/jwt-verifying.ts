...
export const verify = async (request: ClaimVerifyRequest): Promise<ClaimVerifyResult> => {
    ...
    try {
        ...
        result = { userName: claim['cognito:username'], clientId: claim.sub, email: claim.email, isValid: true };
    } catch (error) {
